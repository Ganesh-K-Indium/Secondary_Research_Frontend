...
export function RagChat({ messages, setMessages, sessionId, onSessionUpdate, getUserId }) {
  return (
    <ChatInterface 
      serverUrl={RAG_URL} 
      mode="rag" 
...
export function IngestionChat({ messages, setMessages, sessionId, onSessionUpdate, getUserId }) {
  return (
    <ChatInterface 
